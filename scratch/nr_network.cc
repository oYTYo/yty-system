 ...
 *
 * Topology:
 *   12 UEs (cameras) --(5G NR)-- 1 gNB -- EPC/PGW --(P2P bottleneck, dynamic bandwidth)-- 1 Server
 *
 * Run:
...
main(int argc, char* argv[])
{
    ...
    p2pBackhaul.SetDeviceAttribute("DataRate", StringValue("50Mbps"));
    ...
    serverHelper.SetAttribute("LogFile", StringValue("scratch/play_status_nr.txt"));
