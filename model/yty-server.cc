...
YtyServer::YtyServer() : m_useOracle(false), m_useMinerva(false), m_useAI(false), m_socket(0), m_port(9), m_totalOracleBandwidth(DataRate("0bps")), m_totalCodecWeight(0.0), m_videoComplexity("normal")
{
...
void YtyServer::InitializeVmafLut()
{
    ...
    if (m_videoComplexity == "static") {
        // H.264
        m_vmafLut["H.264"][{854, 480}] = {{18, 78.53}, {19, 77.71}, {20, 76.54}, {21, 75.56}, {22, 74.23}, {23, 72.65}, {24, 71.10}, {25, 69.06}, {26, 66.95}, {27, 64.63}, {28, 62.77}, {29, 60.50}, {30, 57.80}, {31, 56.24}, {32, 53.77}};
        m_vmafLut["H.264"][{1280, 720}] = {{18, 85.94}, {19, 85.26}, {20, 84.55}, {21, 83.65}, {22, 82.62}, {23, 81.41}, {24, 80.07}, {25, 78.25}, {26, 76.69}, {27, 75.21}, {28, 72.83}, {29, 71.19}, {30, 68.58}, {31, 66.42}, {32, 63.75}};
        m_vmafLut["H.264"][{1920, 1080}] = {{18, 90.54}, {19, 89.95}, {20, 89.28}, {21, 88.63}, {22, 87.76}, {23, 86.87}, {24, 85.77}, {25, 84.52}, {26, 83.18}, {27, 81.68}, {28, 80.05}, {29, 78.46}, {30, 76.37}, {31, 74.08}, {32, 71.95}};
        m_vmafLut["H.264"][{2560, 1440}] = {{18, 92.81}, {19, 92.19}, {20, 91.59}, {21, 90.88}, {22, 90.19}, {23, 89.39}, {24, 88.45}, {25, 87.51}, {26, 86.44}, {27, 85.12}, {28, 83.80}, {29, 82.49}, {30, 80.90}, {31, 79.11}, {32, 77.09}};
        // H.265
        m_vmafLut["H.265"][{854, 480}] = {{18, 77.25}, {19, 76.38}, {20, 75.47}, {21, 74.21}, {22, 72.88}, {23, 71.65}, {24, 70.04}, {25, 68.60}, {26, 66.69}, {27, 65.08}, {28, 63.58}, {29, 61.99}, {30, 60.13}, {31, 58.70}, {32, 56.33}};
        m_vmafLut["H.265"][{1280, 720}] = {{18, 84.66}, {19, 84.07}, {20, 83.38}, {21, 82.56}, {22, 81.66}, {23, 80.62}, {24, 79.47}, {25, 78.18}, {26, 76.91}, {27, 75.38}, {28, 73.57}, {29, 71.94}, {30, 69.61}, {31, 67.98}, {32, 64.98}};
        m_vmafLut["H.265"][{1920, 1080}] = {{18, 89.44}, {19, 88.85}, {20, 88.25}, {21, 87.60}, {22, 86.86}, {23, 86.11}, {24, 85.13}, {25, 84.28}, {26, 83.20}, {27, 81.98}, {28, 80.66}, {29, 78.98}, {30, 77.16}, {31, 75.49}, {32, 73.38}};
        m_vmafLut["H.265"][{2560, 1440}] = {{18, 91.88}, {19, 91.29}, {20, 90.64}, {21, 89.95}, {22, 89.30}, {23, 88.57}, {24, 87.78}, {25, 86.97}, {26, 85.95}, {27, 84.98}, {28, 84.05}, {29, 82.62}, {30, 81.30}, {31, 79.48}, {32, 77.93}};

        // VP9
        m_vmafLut["VP9"][{854, 480}] = {{18, 77.75}, {19, 77.61}, {20, 77.41}, {21, 77.21}, {22, 76.83}, {23, 76.76}, {24, 76.36}, {25, 76.13}, {26, 76.06}, {27, 75.48}, {28, 75.14}, {29, 74.12}, {30, 73.21}, {31, 70.11}, {32, 59.20}};
        m_vmafLut["VP9"][{1280, 720}] = {{18, 84.37}, {19, 84.22}, {20, 83.93}, {21, 83.54}, {22, 83.31}, {23, 83.08}, {24, 82.74}, {25, 82.50}, {26, 82.28}, {27, 81.86}, {28, 81.53}, {29, 80.94}, {30, 80.33}, {31, 78.34}, {32, 69.57}};
        m_vmafLut["VP9"][{1920, 1080}] = {{18, 89.34}, {19, 89.08}, {20, 88.76}, {21, 88.25}, {22, 87.73}, {23, 87.27}, {24, 86.85}, {25, 86.46}, {26, 86.11}, {27, 85.62}, {28, 85.22}, {29, 84.66}, {30, 83.79}, {31, 82.45}, {32, 76.04}};
        m_vmafLut["VP9"][{2560, 1440}] = {{18, 91.89}, {19, 91.62}, {20, 91.38}, {21, 90.90}, {22, 90.47}, {23, 89.99}, {24, 89.57}, {25, 89.14}, {26, 88.69}, {27, 88.10}, {28, 87.59}, {29, 86.64}, {30, 85.68}, {31, 84.11}, {32, 79.18}};

        // AV1
        m_vmafLut["AV1"][{854, 480}] = {{18, 77.08}, {19, 76.87}, {20, 76.65}, {21, 76.23}, {22, 75.82}, {23, 75.14}, {24, 74.71}, {25, 74.50}, {26, 74.00}, {27, 73.52}, {28, 72.18}, {29, 71.12}, {30, 69.47}, {31, 67.48}, {32, 61.35}};
        m_vmafLut["AV1"][{1280, 720}] = {{18, 83.93}, {19, 83.70}, {20, 83.57}, {21, 83.33}, {22, 83.10}, {23, 82.69}, {24, 82.49}, {25, 82.16}, {26, 81.82}, {27, 81.41}, {28, 80.45}, {29, 79.75}, {30, 78.71}, {31, 77.00}, {32, 71.02}};
        m_vmafLut["AV1"][{1920, 1080}] = {{18, 88.48}, {19, 88.22}, {20, 87.98}, {21, 87.60}, {22, 87.31}, {23, 87.00}, {24, 86.77}, {25, 86.26}, {26, 86.04}, {27, 85.70}, {28, 84.73}, {29, 84.15}, {30, 83.44}, {31, 81.97}, {32, 76.74}};
        m_vmafLut["AV1"][{2560, 1440}] = {{18, 90.95}, {19, 90.73}, {20, 90.46}, {21, 90.09}, {22, 89.71}, {23, 89.32}, {24, 88.97}, {25, 88.52}, {26, 88.15}, {27, 87.82}, {28, 87.13}, {29, 86.46}, {30, 85.82}, {31, 84.05}, {32, 79.13}};

        
    } else if (m_videoComplexity == "dynamic") {
        
        // H.264
        m_vmafLut["H.264"][{854, 480}] = {{18, 63.22}, {19, 62.04}, {20, 60.77}, {21, 59.27}, {22, 57.69}, {23, 55.87}, {24, 53.89}, {25, 51.73}, {26, 49.44}, {27, 46.91}, {28, 44.33}, {29, 41.57}, {30, 38.54}, {31, 35.55}, {32, 32.46}};
        m_vmafLut["H.264"][{1280, 720}] = {{18, 83.31}, {19, 82.32}, {20, 81.21}, {21, 79.99}, {22, 78.63}, {23, 77.08}, {24, 75.35}, {25, 73.48}, {26, 71.37}, {27, 69.06}, {28, 66.56}, {29, 63.85}, {30, 61.00}, {31, 57.87}, {32, 54.54}};
        m_vmafLut["H.264"][{1920, 1080}] = {{18, 94.72}, {19, 93.91}, {20, 93.05}, {21, 92.10}, {22, 91.06}, {23, 89.91}, {24, 88.58}, {25, 87.12}, {26, 85.47}, {27, 83.61}, {28, 81.52}, {29, 79.22}, {30, 76.68}, {31, 73.90}, {32, 70.84}};
        m_vmafLut["H.264"][{2560, 1440}] = {{18, 98.17}, {19, 97.63}, {20, 96.99}, {21, 96.27}, {22, 95.46}, {23, 94.50}, {24, 93.44}, {25, 92.26}, {26, 90.96}, {27, 89.43}, {28, 87.71}, {29, 85.81}, {30, 83.63}, {31, 81.24}, {32, 78.63}};
        // H.265
        m_vmafLut["H.265"][{854, 480}] = {{18, 63.76}, {19, 62.77}, {20, 61.65}, {21, 60.40}, {22, 59.03}, {23, 57.49}, {24, 55.77}, {25, 53.96}, {26, 51.92}, {27, 49.74}, {28, 47.40}, {29, 44.89}, {30, 42.35}, {31, 39.65}, {32, 36.76}};
        m_vmafLut["H.265"][{1280, 720}] = {{18, 83.78}, {19, 82.94}, {20, 82.01}, {21, 80.98}, {22, 79.82}, {23, 78.55}, {24, 77.09}, {25, 75.48}, {26, 73.71}, {27, 71.76}, {28, 69.60}, {29, 67.30}, {30, 64.74}, {31, 62.04}, {32, 59.13}};
        m_vmafLut["H.265"][{1920, 1080}] = {{18, 94.92}, {19, 94.24}, {20, 93.49}, {21, 92.68}, {22, 91.78}, {23, 90.78}, {24, 89.70}, {25, 88.48}, {26, 87.12}, {27, 85.63}, {28, 83.95}, {29, 82.08}, {30, 80.04}, {31, 77.76}, {32, 75.25}};
        m_vmafLut["H.265"][{2560, 1440}] = {{18, 98.36}, {19, 97.91}, {20, 97.35}, {21, 96.72}, {22, 96.00}, {23, 95.20}, {24, 94.31}, {25, 93.32}, {26, 92.21}, {27, 91.04}, {28, 89.71}, {29, 88.21}, {30, 86.54}, {31, 84.63}, {32, 82.59}};

        // VP9
        m_vmafLut["VP9"][{854, 480}] = {{18, 65.81}, {19, 65.50}, {20, 65.17}, {21, 64.56}, {22, 64.01}, {23, 63.41}, {24, 62.85}, {25, 61.71}, {26, 60.90}, {27, 59.36}, {28, 57.67}, {29, 55.82}, {30, 52.66}, {31, 48.24}, {32, 40.61}};
        m_vmafLut["VP9"][{1280, 720}] = {{18, 85.40}, {19, 85.11}, {20, 84.82}, {21, 84.25}, {22, 83.75}, {23, 83.22}, {24, 82.71}, {25, 81.72}, {26, 80.99}, {27, 79.62}, {28, 78.07}, {29, 76.35}, {30, 73.34}, {31, 69.14}, {32, 61.60}};
        m_vmafLut["VP9"][{1920, 1080}] = {{18, 96.28}, {19, 96.07}, {20, 95.83}, {21, 95.40}, {22, 95.00}, {23, 94.55}, {24, 94.13}, {25, 93.28}, {26, 92.69}, {27, 91.56}, {28, 90.27}, {29, 88.90}, {30, 86.42}, {31, 82.66}, {32, 76.03}};
        m_vmafLut["VP9"][{2560, 1440}] = {{18, 99.02}, {19, 98.91}, {20, 98.78}, {21, 98.53}, {22, 98.29}, {23, 97.99}, {24, 97.70}, {25, 97.07}, {26, 96.62}, {27, 95.69}, {28, 94.62}, {29, 93.45}, {30, 91.41}, {31, 88.20}, {32, 82.36}};

        // AV1
        m_vmafLut["AV1"][{854, 480}] = {{18, 64.09}, {19, 63.69}, {20, 63.26}, {21, 62.58}, {22, 61.85}, {23, 61.17}, {24, 60.49}, {25, 59.71}, {26, 59.15}, {27, 56.83}, {28, 55.32}, {29, 53.15}, {30, 50.00}, {31, 45.50}, {32, 36.67}};
        m_vmafLut["AV1"][{1280, 720}] = {{18, 84.50}, {19, 84.15}, {20, 83.78}, {21, 83.15}, {22, 82.51}, {23, 81.89}, {24, 81.32}, {25, 80.67}, {26, 80.15}, {27, 78.18}, {28, 76.79}, {29, 74.97}, {30, 72.08}, {31, 67.82}, {32, 59.04}};
        m_vmafLut["AV1"][{1920, 1080}] = {{18, 95.80}, {19, 95.57}, {20, 95.27}, {21, 94.78}, {22, 94.28}, {23, 93.79}, {24, 93.29}, {25, 92.77}, {26, 92.30}, {27, 90.68}, {28, 89.51}, {29, 87.98}, {30, 85.59}, {31, 82.12}, {32, 74.55}};
        m_vmafLut["AV1"][{2560, 1440}] = {{18, 98.81}, {19, 98.69}, {20, 98.54}, {21, 98.27}, {22, 97.97}, {23, 97.65}, {24, 97.30}, {25, 96.92}, {26, 96.56}, {27, 95.26}, {28, 94.27}, {29, 92.92}, {30, 90.82}, {31, 87.80}, {32, 81.41}};
